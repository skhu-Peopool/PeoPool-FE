...
import { User, Edit3, Lock, Calendar, Mail, Phone, MessageCircle, Award, BookOpen, PenTool } from 'lucide-react';
      ...
      <ContentWrapper>
        ...
        <ProfileCard>
          ...
          <ProfileInfo>
            ...
            <TagsContainer>
              <InfoLabel style={{ marginBottom: '0.75rem', display: 'block' }}>관심 분야</InfoLabel>
              {isEditing ? (
                <TagInput
                  type="text"
                  value={tagInput}
            ...
            <Introduction>
              {isEditing ? (
                ...
                <>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginTop: '1rem', color: '#4b5563' }}>
                    <MessageCircle size={20} color="#60a5fa" />
                    <strong style={{ color: '#1f2937' }}>카카오톡:</strong> {profileData.kakaoId}
                  </div>
                </>
              )}
            </Introduction>
